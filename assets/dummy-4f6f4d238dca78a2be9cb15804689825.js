...
e.default=g})),define("dummy/controllers/demo",["exports","@ember/controller","@ember/service","@ember/object","@glimmer/tracking"],(function(e,t,r,n,o){var i,u,c,l,f,a,p
function s(e,t,r,n){r&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(n):void 0})}function y(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function d(e,t){for(var r=0;r<t.length;r++){var n=t[r]
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function b(e,t){return b=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e},b(e,t)}function m(e){var t=function(){if("undefined"==typeof Reflect||!Reflect.construct)return!1
if(Reflect.construct.sham)return!1
if("function"==typeof Proxy)return!0
try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){}))),!0}catch(e){return!1}}()
...
return e}function w(e){return w=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)},w(e)}function g(e,t,r,n,o){var i={}
return Object.keys(n).forEach((function(e){i[e]=n[e]})),i.enumerable=!!i.enumerable,i.configurable=!!i.configurable,("value"in i||i.initializer)&&(i.writable=!0),i=r.slice().reverse().reduce((function(r,n){return n(e,t,r)||r}),i),o&&void 0!==i.initializer&&(i.value=i.initializer?i.initializer.call(o):void 0,i.initializer=void 0),void 0===i.initializer&&(Object.defineProperty(e,t,i),i=null),i}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var O=(i=(0,r.inject)("window-messenger-server"),u=(0,r.inject)("window-messenger-client"),c=function(e){(function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&b(e,t)})(i,e)
var t,r,n,o=m(i)
function i(){var e
y(this,i)
for(var t=arguments.length,r=new Array(t),n=0;n<t;n++)r[n]=arguments[n]
return s(h(e=o.call.apply(o,[this].concat(r))),"server",l,h(e)),s(h(e),"client",f,h(e)),s(h(e),"popup",a,h(e)),s(h(e),"model",p,h(e)),e}return t=i,(r=[{key:"askTarget1",value:function(){var e=this
this.client.fetch("target-1:name").then((function(t){e.model=t}))}},{key:"openPopup",value:function(){var e=window.open("/client-server-two/example","Example popup","toolbar=no,resizable=no,width=400,height=400")
this.client.addTarget("popup",e),this.popup=!0}},{key:"askPopup",value:function(){var e=this
this.client.fetch("popup:popup-name").then((function(t){e.model=t}))}}])&&d(t.prototype,r),n&&d(t,n),i}(t.default),l=g(c.prototype,"server",[i],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),f=g(c.prototype,"client",[u],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),a=g(c.prototype,"popup",[o.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),p=g(c.prototype,"model",[o.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),g(c.prototype,"askTarget1",[n.action],Object.getOwnPropertyDescriptor(c.prototype,"askTarget1"),c.prototype),g(c.prototype,"openPopup",[n.action],Object.getOwnPropertyDescriptor(c.prototype,"openPopup"),c.prototype),g(c.prototype,"askPopup",[n.action],Object.getOwnPropertyDescriptor(c.prototype,"askPopup"),c.prototype),c)
e.default=O})),define("dummy/helpers/page-title",["exports","ember-page-title/helpers/page-title"],(function(e,t){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var r=t.default
...
runningTests||require("dummy/app").default.create({"ember-window-messenger":{parent:"http://localhost:4200","target-1":"http://localhost:4200","target-2":"http://localhost:4200",popup:"http://localhost:4200"}})
